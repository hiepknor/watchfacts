...
- For search engine upgrades across pipeline naming, query recognition, brand/reference taxonomy, retrieval planning, candidate processing, result delivery, or ranking guardrails: read `search-engine-upgrade-plan.md`, `technical-spec.md`, `production-quality-audit.md`, and ADR-001.
